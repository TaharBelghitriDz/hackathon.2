...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
     ...
     * @secure
     */
    answersCreate: (data: Answer, params: RequestParams = {}) =>
     ...
     * @secure
     */
    authCreate: (data: LoginModel, params: RequestParams = {}) =>
     ...
     * @secure
     */
    pollsList: (params: RequestParams = {}) =>
     ...
     * @secure
     */
    pollsCreate: (data: Poll, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/api/Polls`,
        method: "POST",
        body: data,
     ...
     *
     * @tags Route
     * @name RouteByRouteNameDetail
     * @request GET:/api/Route/byRouteName/{day}
     * @secure
     */
    routeByRouteNameDetail: (day: number, params: RequestParams = {}) =>
      this.request<RouteDashbord, any>({
        path: `/api/Route/byRouteName/${day}`,
        method: "GET",
        secure: true,
        format: "json",
        ...params,
